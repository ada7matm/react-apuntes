...
Para que dichos componentes se muestren, debemos especificar en qué lugar queremos que se renderizen. Los componentes anidados o hijos, se pasan al elemento padre de la propiedad **children** de props, por lo tanto, dentro del elemento padre, tenemos que definir dónde queremos que se incluyan:
